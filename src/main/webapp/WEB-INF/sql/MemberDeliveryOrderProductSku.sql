#namespace("member_delivery_order_product_sku")
  ...
  #sql("listByMember_delivery_order_id")
    SELECT
    table_member_delivery_order_product_sku.*,
    ...
    WHERE table_member_delivery_order_product_sku.system_status = 1
    AND table_member_delivery_order_product_sku.member_delivery_order_id = #p(member_delivery_order_id)
    ORDER BY table_member_delivery_order_product_sku.system_create_time DESC
  #end
