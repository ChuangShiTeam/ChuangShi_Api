#namespace("trade")
  ...
  #sql("save")
    INSERT INTO table_trade (
      ...
      #p(trade_total_amount),
      #p(trade_is_commission),
      #p(trade_is_confirm),
      #p(trade_is_pay),
      #p(trade_flow),
      #p(trade_deliver_pattern),
      #p(trade_status),
  ...
  #sql("update")
    ...
    trade_total_amount = #p(trade_total_amount),
    ...
    trade_deliver_pattern = #p(trade_deliver_pattern),
  ...
  #sql("updateTrade_flowByTrade_idValidateSystem_version")
    UPDATE table_trade SET
    trade_flow = #p(trade_flow),
    system_update_user_id = #p(system_update_user_id),
    system_update_time = #p(system_update_time),
