#namespace("stock_product_sku")

  #sql("listAndProduct_nameByStock_id")
    SELECT
    ...
    WHERE table_stock_product_sku.system_status = 1
    AND table_stock_product_sku.stock_id = #p(stock_id)
    ORDER BY table_stock_product_sku.system_create_time DESC
  #end


  #sql("save")
    INSERT INTO table_stock_product_sku (
      stock_id,
      product_sku_id,
  ...
  #sql("deleteByStock_idAndSystem_version")
    UPDATE table_stock_product_sku SET
