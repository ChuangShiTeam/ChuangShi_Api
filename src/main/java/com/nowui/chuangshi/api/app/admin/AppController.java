...
public class AppController extends Controller {
    ...
    public void save() {
        ...
        Boolean result = AppService.instance.save(model);
    ...
    public void update() {
        ...
        Boolean result = AppService.instance.update(model, model.getApp_id(), model.getSystem_version());
    ...
    public void delete() {
        ...
        Boolean result = AppService.instance.delete(model.getApp_id(), model.getSystem_version());
