...
public class ProductController extends Controller {
    ...
    private final ProductService articleService = ProductService.me;
    ...
    public void list() {
        ...
        List<Product> resultList = articleService.list(model.paginate());
    ...
    public void find() {
        ...
        Product result = articleService.find(model);
