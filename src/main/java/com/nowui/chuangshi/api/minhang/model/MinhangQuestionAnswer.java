...
@Entity
public class MinhangQuestionAnswer extends Model<MinhangQuestionAnswer> {

    @Table
    public static final String TABLE_MINHANG_QUESTION_ANSWER = "table_minhang_question_answer";
    ...
    @Column(type = ColumnType.VARCHAR, length = 2000, comment = "题目答案")
    ...
    public String getQuestion_answer_id() {
        return getStr(QUESTION_ANSWER_ID);
    }

    public void setQuestion_answer_id(String question_answer_id) {
        set(QUESTION_ANSWER_ID, question_answer_id);
    }
