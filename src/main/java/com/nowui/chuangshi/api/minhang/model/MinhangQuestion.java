...
public class MinhangQuestion extends Model<MinhangQuestion> {
    ...
    @Column(type = ColumnType.VARCHAR, length = 200, comment = "题目二维码")
    public static final String QUESTION_QRCODE_URL = "question_qrcode_url";
    ...
    public String getQuestion_qrcode_url() {
        return getStr(QUESTION_QRCODE_URL);
    }

    public void setQuestion_qrcode_url(String question_qrcode_url) {
        set(QUESTION_QRCODE_URL, question_qrcode_url);
    }
