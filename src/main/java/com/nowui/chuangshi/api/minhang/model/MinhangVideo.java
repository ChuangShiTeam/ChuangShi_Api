...
@Entity
public class MinhangVideo extends Model<MinhangVideo> {

    @Table
    public static final String TABLE_MINHANG_VIDEO = "table_minhang_video";

    @Primary
    @Column(type = ColumnType.VARCHAR, length = 32, comment = "视频编号", updatable = false)
    ...
    public Integer getVideo_sort() {
        return getInt(VIDEO_SORT);
    }

    public void setVideo_sort(Integer video_sort) {
        set(VIDEO_SORT, video_sort);
    }
