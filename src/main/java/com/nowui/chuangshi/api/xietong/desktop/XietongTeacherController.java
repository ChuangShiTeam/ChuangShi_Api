...
public class XietongTeacherController extends Controller {
    ...
    public void list() {
        ...
        String[] teacher_category_id = xietongTeacher.getTeacher_category_id().split("_");

        Integer resultCount = XietongTeacherService.instance.desktopCount(request_app_id, teacher_category_id);
        List<XietongTeacher> resultList = XietongTeacherService.instance.desktopList(request_app_id, teacher_category_id, getM(), getN());
