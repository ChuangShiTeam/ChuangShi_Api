...
public class XietongCourseController extends Controller {
    ...
    public void list() {
        ...
        validateResponse(XietongCourse.IS_APPLY, XietongCourse.COURSE_ID, XietongCourse.COURSE_NAME, XietongCourse.COURSE_TEACHER, XietongCourse.COURSE_TIME, XietongCourse.COURSE_APPLY_LIMIT, XietongCourse.COURSE_APPLY_COUNT);
    ...
    public void applyList() {
        ...
        validateResponse(XietongCourse.COURSE_ID, XietongCourse.COURSE_NAME, XietongCourse.COURSE_TEACHER, XietongCourse.COURSE_TIME, XietongCourse.COURSE_APPLY_LIMIT, XietongCourse.COURSE_APPLY_COUNT, XietongCourseApply.USER_ID);
