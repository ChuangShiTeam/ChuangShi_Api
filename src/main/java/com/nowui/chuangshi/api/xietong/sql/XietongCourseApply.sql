#namespace("xietong_course_apply")
  ...
  #sql("oneDayCount")
   ...
   #sql("save")
    INSERT INTO table_xietong_course_apply (course_apply_id, course_id, user_id, system_create_user_id, system_create_time, system_update_user_id, system_update_time, system_status)
