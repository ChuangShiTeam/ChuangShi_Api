...
public class XietongTeacherService extends Service {
    ...
    public XietongTeacher find(String teacher_id) {
        ...
        if (xietong_teacher == null) {
            ...
            xietong_teacher.put(User.USER_ACCOUNT, UserService.instance.find(xietong_teacher.getUser_id()).getUser_account());
    ...
    public Boolean save(XietongTeacher xietong_teacher, User user, String request_user_id) {
        ...
        if (result) {
            UserService.instance.userAccountSave(user_id, xietong_teacher.getApp_id(), xietong_teacher.getTeacher_id(), UserType.TEACHER.getKey(), xietong_teacher.getTeacher_name(), user.getUser_account(), user.getUser_password(), request_user_id);
        }
    ...
    public Boolean update(XietongTeacher xietong_teacher, User user, String request_user_id, Integer system_version) {
        ...
        if (success) {
            UserService.instance.userNameUpdate(user.getUser_id(), xietong_teacher.getTeacher_name(), request_user_id);
