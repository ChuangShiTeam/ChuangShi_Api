...
public class FeijiuRecommendProductCache extends Cache {
    ...
    public Integer countByApp_id(String app_id, String request_app_id, String request_http_id, String request_user_id) {
        return feijiuRecommendProductDao.countByApp_id(app_id, request_app_id, request_http_id, request_user_id);
    }

    public Integer countByOrApp_id(String app_id, String request_app_id, String request_http_id, String request_user_id) {
        return feijiuRecommendProductDao.countByOrApp_id(app_id, request_app_id, request_http_id, request_user_id);
    }
    ...
    public List<FeijiuRecommendProduct> listByApp_idAndSystem_create_timeAndLimit(String app_id, Date system_create_time, int m, int n, String request_app_id, String request_http_id, String request_user_id) {
        List<FeijiuRecommendProduct> feijiu_recommend_productList = feijiuRecommendProductDao.listByApp_idAndSystem_create_timeAndLimit(app_id, system_create_time, m, n, request_app_id, request_http_id, request_user_id);

        for (FeijiuRecommendProduct feijiu_recommend_product : feijiu_recommend_productList) {
            feijiu_recommend_product.put(findByProduct_id(feijiu_recommend_product.getProduct_id(), request_app_id, request_http_id, request_user_id));
        }
    ...
    public List<FeijiuRecommendProduct> listByApp_id(String app_id, String request_app_id, String request_http_id, String request_user_id) {
        List<FeijiuRecommendProduct> feijiu_recommend_productList = feijiuRecommendProductDao.listByApp_id(app_id, request_app_id, request_http_id, request_user_id);
    ...
    public List<FeijiuRecommendProduct> listByApp_idAndLimit(String app_id, int m, int n, String request_app_id, String request_http_id, String request_user_id) {
        List<FeijiuRecommendProduct> feijiu_recommend_productList = feijiuRecommendProductDao.listByApp_idAndLimit(app_id, m, n, request_app_id, request_http_id, request_user_id);
    ...
    public List<FeijiuRecommendProduct> listByOrApp_idAndLimit(String app_id, int m, int n, String request_app_id, String request_http_id, String request_user_id) {
        List<FeijiuRecommendProduct> feijiu_recommend_productList = feijiuRecommendProductDao.listByOrApp_idAndLimit(app_id, m, n, request_app_id, request_http_id, request_user_id);
    ...
    public FeijiuRecommendProduct findByProduct_id(String product_id, String request_app_id, String request_http_id, String request_user_id) {
        ...
        if (feijiu_recommend_product == null) {
            feijiu_recommend_product = feijiuRecommendProductDao.findByProduct_id(product_id, request_app_id, request_http_id, request_user_id);
    ...
    public Boolean deleteByProduct_idAndSystem_update_user_idValidateSystem_version(String product_id, String system_update_user_id, Integer system_version, String request_app_id, String request_http_id, String request_user_id) {
        ...
        boolean result = feijiuRecommendProductDao.deleteByProduct_idAndSystem_version(product_id, system_update_user_id, system_version, request_app_id, request_http_id, request_user_id);
