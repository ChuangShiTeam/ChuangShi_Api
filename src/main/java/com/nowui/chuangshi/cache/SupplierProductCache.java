...
public class SupplierProductCache extends Cache {
    ...
    public static final String SUPPLIER_PRODUCT_LIST_BY_SUPPLIER_ID_CACHE = "supplier_product_list_by_supplier_id_cache";
    ...
    public List<SupplierProduct> listBySupplier_id(String supplier_id) {
        List<SupplierProduct> supplierProductlist = CacheUtil.get(SUPPLIER_PRODUCT_LIST_BY_SUPPLIER_ID_CACHE,
                supplier_id);

        if (supplierProductlist == null || supplierProductlist.size() == 0) {
            supplierProductlist = supplierProductDao.findBySupplier_id(supplier_id);

            CacheUtil.put(SUPPLIER_PRODUCT_LIST_BY_SUPPLIER_ID_CACHE, supplier_id, supplierProductlist);
        }
    ...
    public List<SupplierProduct> listByApp_idAndSystem_create_timeAndLimit(String app_id, Date system_create_time,
            int m, int n) {
        List<SupplierProduct> supplier_productList = supplierProductDao
    ...
    public List<SupplierProduct> listByApp_idOrLikeSupplier_product_nameAndLimit(String app_id,
        ...
        List<SupplierProduct> supplier_productList = supplierProductDao
                .listByApp_idOrLikeSupplier_product_nameAndLimit(app_id, supplier_product_name, m, n);
    ...
    public List<SupplierProduct> listByOrApp_idOrLikeSupplier_product_nameAndLimit(String app_id,
            String supplier_product_name, int m, int n) {
        List<SupplierProduct> supplier_productList = supplierProductDao
                .listByOrApp_idOrLikeSupplier_product_nameAndLimit(app_id, supplier_product_name, m, n);
    ...
    public SupplierProduct findBySupplier_product_id(String supplier_product_id) {
        SupplierProduct supplier_product = CacheUtil.get(SUPPLIER_PRODUCT_BY_SUPPLIER_PRODUCT_ID_CACHE,
                supplier_product_id);
    ...
    public Boolean batchSave(List<SupplierProduct> supplierProductList, String supplier_id) {
        Boolean result = supplierProductDao.batchSave(supplierProductList);
        if (result) {
            CacheUtil.remove(SUPPLIER_PRODUCT_LIST_BY_SUPPLIER_ID_CACHE, supplier_id);
        }
        return result;
    }
    ...
    public Boolean updateValidateSystem_version(String supplier_product_id, String supplier_id, String product_id,
        ...
        boolean result = supplierProductDao.update(supplier_product_id, supplier_id, product_id, system_update_user_id,
                system_version);
    ...
    public Boolean deleteBySupplier_product_idAndSystem_update_user_idValidateSystem_version(String supplier_product_id,
        ...
        boolean result = supplierProductDao.deleteBySupplier_product_idAndSystem_version(supplier_product_id,
    ...
    public boolean deleteBySupplier_id(String supplier_id, String system_update_user_id) {
        boolean result = supplierProductDao.deleteBySupplier_id(supplier_id, system_update_user_id);
