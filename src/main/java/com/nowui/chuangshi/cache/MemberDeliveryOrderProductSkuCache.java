...
public class MemberDeliveryOrderProductSkuCache extends Cache {
    ...
    public Boolean save(String member_delivery_order_id, String product_sku_id, String product_snap_id, Integer product_sku_quantity, BigDecimal product_sku_amount, String system_create_user_id) {
        return memberDeliveryOrderProductSkuDao.save(member_delivery_order_id, product_sku_id, product_snap_id, product_sku_quantity, product_sku_amount, system_create_user_id);
    }
