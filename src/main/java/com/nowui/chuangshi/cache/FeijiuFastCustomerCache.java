...
public class FeijiuFastCustomerCache extends Cache {
    ...
    public Integer countByApp_idAndCustomer_name(String app_id, String customer_name) {
        return feijiuFastCustomerDao.countByApp_idAndCustomer_name(app_id, customer_name);
    }

    public Integer countByOrApp_id(String app_id) {
        return feijiuFastCustomerDao.countByOrApp_id(app_id);
    }
    ...
    public List<FeijiuFastCustomer> listByApp_idAndSystem_create_timeAndLimit(String app_id, Date system_create_time, int m, int n) {
        List<FeijiuFastCustomer> feijiu_fast_customerList = feijiuFastCustomerDao.listByApp_idAndSystem_create_timeAndLimit(app_id, system_create_time, m, n);

        for (FeijiuFastCustomer feijiu_fast_customer : feijiu_fast_customerList) {
            feijiu_fast_customer.put(findByCustomer_id(feijiu_fast_customer.getCustomer_id()));
        }
    ...
    public List<FeijiuFastCustomer> listByApp_id(String app_id) {
        List<FeijiuFastCustomer> feijiu_fast_customerList = feijiuFastCustomerDao.listByApp_id(app_id);
    ...
    public List<FeijiuFastCustomer> listByApp_idAndCustomer_nameAndLimit(String app_id, String customer_name, int m, int n) {
        List<FeijiuFastCustomer> feijiu_fast_customerList = feijiuFastCustomerDao.listByApp_idAndCustomer_nameAndLimit(app_id, customer_name, m, n);
    ...
    public List<FeijiuFastCustomer> listByOrApp_idAndLimit(String app_id, int m, int n) {
        List<FeijiuFastCustomer> feijiu_fast_customerList = feijiuFastCustomerDao.listByOrApp_idAndLimit(app_id, m, n);
    ...
    public FeijiuFastCustomer findByCustomer_id(String customer_id) {
        ...
        if (feijiu_fast_customer == null) {
            feijiu_fast_customer = feijiuFastCustomerDao.findByCustomer_id(customer_id);
    ...
    public Boolean save(String customer_id, String app_id, String customer_name, String customer_phone, String customer_birthday, String customer_city, String customer_sex, String customer_id_card, String customer_money, String customer_fang, String customer_che, String customer_xin, String customer_shou, String customer_dai, String customer_gong, String system_create_user_id) {
        return feijiuFastCustomerDao.save(customer_id, app_id, customer_name, customer_phone, customer_birthday, customer_city, customer_sex, customer_id_card, customer_money, customer_fang, customer_che, customer_xin, customer_shou, customer_dai, customer_gong, system_create_user_id);
    }
    ...
    public Boolean updateValidateSystem_version(String customer_id, String customer_name, String customer_phone, String customer_birthday, String customer_city, String customer_sex, String customer_id_card, String customer_money, String customer_fang, String customer_che, String customer_xin, String customer_shou, String customer_dai, String customer_gong, String system_update_user_id, Integer system_version) {
        FeijiuFastCustomer feijiu_fast_customer = findByCustomer_id(customer_id);
        if (!feijiu_fast_customer.getSystem_version().equals(system_version)) {
            throw new RuntimeException(Constant.ERROR_VERSION);
        }

        boolean result = feijiuFastCustomerDao.update(customer_id, customer_name, customer_phone, customer_birthday, customer_city, customer_sex, customer_id_card, customer_money, customer_fang, customer_che, customer_xin, customer_shou, customer_dai, customer_gong, system_update_user_id, system_version);
    ...
    public Boolean deleteByCustomer_idAndSystem_update_user_idValidateSystem_version(String customer_id, String system_update_user_id, Integer system_version) {
        ...
        boolean result = feijiuFastCustomerDao.deleteByCustomer_idAndSystem_version(customer_id, system_update_user_id, system_version);
