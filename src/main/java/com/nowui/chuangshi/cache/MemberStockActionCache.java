...
public class MemberStockActionCache extends Cache {
    ...
    public Integer countByApp_idOrLikeMember_stock_action_name(String app_id, String member_stock_action_name, String request_app_id, String request_http_id, String request_user_id) {
        return memberStockActionDao.countByApp_idOrLikeMember_stock_action_name(app_id, member_stock_action_name, request_app_id, request_http_id, request_user_id);
    }
    ...
    public Integer countByOrApp_idOrLikeMember_stock_action_name(String app_id, String member_stock_action_name, String request_app_id, String request_http_id, String request_user_id) {
        return memberStockActionDao.countByOrApp_idOrLikeMember_stock_action_name(app_id, member_stock_action_name, request_app_id, request_http_id, request_user_id);
    }
    ...
    public List<MemberStockAction> listByApp_idAndSystem_create_timeAndLimit(String app_id, Date system_create_time, int m, int n, String request_app_id, String request_http_id, String request_user_id) {
        List<MemberStockAction> member_stock_actionList = memberStockActionDao.listByApp_idAndSystem_create_timeAndLimit(app_id, system_create_time, m, n, request_app_id, request_http_id, request_user_id);

        for (MemberStockAction member_stock_action : member_stock_actionList) {
            member_stock_action.put(findByMember_stock_action_id(member_stock_action.getMember_stock_action_id(), request_app_id, request_http_id, request_user_id));
        }
    ...
    public List<MemberStockAction> listByApp_idOrLikeMember_stock_action_nameAndLimit(String app_id, String member_stock_action_name, int m, int n, String request_app_id, String request_http_id, String request_user_id) {
        List<MemberStockAction> member_stock_actionList = memberStockActionDao.listByApp_idOrLikeMember_stock_action_nameAndLimit(app_id, member_stock_action_name, m, n, request_app_id, request_http_id, request_user_id);
    ...
    public List<MemberStockAction> listByOrApp_idOrLikeMember_stock_action_nameAndLimit(String app_id, String member_stock_action_name, int m, int n, String request_app_id, String request_http_id, String request_user_id) {
        List<MemberStockAction> member_stock_actionList = memberStockActionDao.listByOrApp_idOrLikeMember_stock_action_nameAndLimit(app_id, member_stock_action_name, m, n, request_app_id, request_http_id, request_user_id);
    ...
    public MemberStockAction findByMember_stock_action_id(String member_stock_action_id, String request_app_id, String request_http_id, String request_user_id) {
        ...
        if (member_stock_action == null) {
            member_stock_action = memberStockActionDao.findByMember_stock_action_id(member_stock_action_id, request_app_id, request_http_id, request_user_id);
    ...
    public Boolean save(String member_stock_action_id, String app_id, String member_id, String user_id, String product_sku_id, String member_stock_action_name, Integer member_stock_quantity, String system_create_user_id, String request_app_id, String request_http_id, String request_user_id) {
        return memberStockActionDao.save(member_stock_action_id, app_id, member_id, user_id, product_sku_id, member_stock_action_name, member_stock_quantity, system_create_user_id, request_app_id, request_http_id, request_user_id);
    }
    ...
    public Boolean updateValidateSystem_version(String member_stock_action_id, String member_id, String user_id, String product_sku_id, String member_stock_action_name, Integer member_stock_quantity, String system_update_user_id, Integer system_version, String request_app_id, String request_http_id, String request_user_id) {
        MemberStockAction member_stock_action = findByMember_stock_action_id(member_stock_action_id, request_app_id, request_http_id, request_user_id);
        if (!member_stock_action.getSystem_version().equals(system_version)) {
            throw new RuntimeException(Constant.ERROR_VERSION);
        }

        boolean result = memberStockActionDao.update(member_stock_action_id, member_id, user_id, product_sku_id, member_stock_action_name, member_stock_quantity, system_update_user_id, system_version, request_app_id, request_http_id, request_user_id);
    ...
    public Boolean deleteByMember_stock_action_idAndSystem_update_user_idValidateSystem_version(String member_stock_action_id, String system_update_user_id, Integer system_version, String request_app_id, String request_http_id, String request_user_id) {
        ...
        boolean result = memberStockActionDao.deleteByMember_stock_action_idAndSystem_version(member_stock_action_id, system_update_user_id, system_version, request_app_id, request_http_id, request_user_id);
