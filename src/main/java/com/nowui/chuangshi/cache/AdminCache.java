...
public class AdminCache extends Cache {
    ...
    public Integer countByApp_idOrLikeUser_name(String app_id, String user_name) {
        return adminDao.countByApp_idOrLikeUser_name(app_id, user_name);
    }

    public Integer countByOrApp_idOrLikeUser_name(String app_id, String user_name) {
        return adminDao.countByOrApp_idOrLikeUser_name(app_id, user_name);
    }

    public List<Admin> listByApp_idAndSystem_create_timeAndLimit(String app_id, Date system_create_time, int m, int n) {
        List<Admin> adminList = adminDao.listByApp_idAndSystem_create_timeAndLimit(app_id, system_create_time, m, n);

        for (Admin admin : adminList) {
            admin.put(findByAdmin_id(admin.getAdmin_id()));
        }
    ...
    public List<Admin> listByApp_idOrLikeUser_nameAndLimit(String app_id, String user_name, int m, int n) {
        List<Admin> adminList = adminDao.listByApp_idOrLikeUser_nameAndLimit(app_id, user_name, m, n);
    ...
    public List<Admin> listByOrApp_idOrLikeUser_nameAndLimit(String app_id, String user_name, int m, int n) {
        List<Admin> adminList = adminDao.listByOrApp_idOrLikeUser_nameAndLimit(app_id, user_name, m, n);
    ...
    public Admin findByAdmin_id(String admin_id) {
        ...
        if (admin == null) {
            admin = adminDao.findByAdmin_id(admin_id);
    ...
    public Boolean save(String admin_id, String app_id, String user_id, String system_create_user_id) {
        return adminDao.save(admin_id, app_id, user_id, system_create_user_id);
    }

    public Boolean updateValidateSystem_version(String admin_id, String system_update_user_id, Integer system_version) {
        Admin admin = findByAdmin_id(admin_id);
        if (!admin.getSystem_version().equals(system_version)) {
            throw new RuntimeException(Constant.ERROR_VERSION);
        }

        boolean result = adminDao.update(admin_id, system_update_user_id, system_version);
    ...
    public Boolean deleteByAdmin_idAndSystem_update_user_idValidateSystem_version(String admin_id, String system_update_user_id, Integer system_version) {
        ...
        boolean result = adminDao.deleteByAdmin_idAndSystem_version(admin_id, system_update_user_id, system_version);
