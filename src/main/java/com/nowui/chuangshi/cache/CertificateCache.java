...
public class CertificateCache extends Cache {
    ...
    public List<Certificate> listByApp_idAndSystem_create_timeAndLimit(String app_id, Date system_create_time, int m, int n) {
        List<Certificate> certificateList = certificateDao.listByApp_idAndSystem_create_timeAndLimit(app_id, system_create_time, m, n);
    ...
    public List<Certificate> listByApp_idOrLikeCertificate_numberAndLimit(String app_id, String certificate_number, int m, int n) {
        List<Certificate> certificateList = certificateDao.listByApp_idOrLikeCertificate_numberAndLimit(app_id, certificate_number, m, n);
    ...
    public List<Certificate> listByOrApp_idOrLikeCertificate_numberAndLimit(String app_id, String certificate_name, int m, int n) {
        List<Certificate> certificateList = certificateDao.listByOrApp_idOrLikeCertificate_numberAndLimit(app_id, certificate_name, m, n);
    ...
    public Boolean save(String certificate_id, String app_id, String user_id, String certificate_number, Date certificate_start_date, Date certificate_end_date, String certificate_content, String certificate_file, String system_create_user_id) {
        return certificateDao.save(certificate_id, app_id, user_id, certificate_number, certificate_start_date, certificate_end_date, certificate_content, certificate_file, system_create_user_id);
    }

    public Boolean updateValidateSystem_version(String certificate_id, String user_id, String certificate_number, Date certificate_start_date, Date certificate_end_date, String certificate_content, String certificate_file, String system_update_user_id, Integer system_version) {
        ...
        boolean result = certificateDao.update(certificate_id, user_id, certificate_number, certificate_start_date, certificate_end_date, certificate_content, certificate_file, system_update_user_id, system_version);
    ...
    public Boolean deleteByCertificate_idAndSystem_update_user_idValidateSystem_version(String certificate_id, String system_update_user_id, Integer system_version) {
        Certificate certificate = findByCertificate_id(certificate_id);
        if (!certificate.getSystem_version().equals(system_version)) {
            throw new RuntimeException(Constant.ERROR_VERSION);
        }

        boolean result = certificateDao.deleteByCertificate_idAndSystem_version(certificate_id, system_update_user_id, system_version);
