...
public class UserCache extends Cache {
    ...
    public User findByApp_idAndUser_typeAndWechat_open_idAndWechat_union_id(String app_id, String user_type,
        ...
        User user = userDao.findByApp_idAndUser_typeAndWechat_open_idAndWechat_union_id(app_id, user_type,
                wechat_open_id, wechat_union_id);
    ...
    public User findByApp_idAndUser_typeAndUser_accountAndUser_password(String app_id, String user_type,
        ...
        User user = userDao.findByApp_idAndUser_typeAndUser_accountAndUser_password(app_id, user_type, user_account,
                user_password);
    ...
    public Boolean save(String user_id, String app_id, String object_id, String user_type, String user_name,
        ...
        return userDao.save(user_id, app_id, object_id, user_type, user_name, user_avatar, user_account, user_mobile,
    ...
    public boolean updateByUser_nameAndUser_accountAndUser_password(String user_id, String user_name,
        ...
        boolean result = userDao.updateByUser_nameAndUser_accountAndUser_password(user_id, user_name, user_account,
