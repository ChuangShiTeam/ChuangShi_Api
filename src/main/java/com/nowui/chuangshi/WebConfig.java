...
public class WebConfig extends JFinalConfig {
    ...
    /*
     * private void initJiYiGuangDatabase() { List<Record> memberLevelRecordList
     * = Db.find("select * from JiYiGuan.table_member_level"); for (Record
     * record : memberLevelRecordList) { String member_level_id =
     * record.getStr("member_level_id"); String app_id =
     * "df2078d6c9eb46babb0df957127273ab"; String member_level_name =
     * record.getStr("member_level_name"); Integer member_level_value =
     * record.getInt("member_level_value"); Integer member_level_sort =
     * record.getInt("member_level_sort"); String system_create_user_id =
     * record.getStr("system_create_user_id"); Date system_create_time =
     * record.getDate("system_create_time"); String system_update_user_id =
     * record.getStr("system_update_user_id"); Date system_update_time =
     * record.getDate("system_update_time"); Integer system_version = 0; Boolean
     * system_status = record.getBoolean("system_status");
     * 
     * Kv sqlMap = Kv.create(); sqlMap.put(MemberLevel.MEMBER_LEVEL_ID,
     * member_level_id); sqlMap.put(MemberLevel.APP_ID, app_id);
     ...
     * sqlMap.put(User.SYSTEM_STATUS, system_status); SqlPara sqlPara =
     * Db.getSqlPara("member_level.save", sqlMap); Db.update(sqlPara.getSql(),
     * sqlPara.getPara()); }
     * 
     * List<Record> fileRecordList =
     * Db.find("select * from JiYiGuan.table_file"); for (Record record :
     * fileRecordList) { String file_id = record.getStr("file_id"); String
     * app_id = "df2078d6c9eb46babb0df957127273ab"; String file_type =
     * record.getStr("file_type"); String file_name =
     * record.getStr("file_name"); String file_suffix =
     * record.getStr("file_suffix"); Integer file_size =
     * record.getInt("file_size"); String file_path =
     * record.getStr("file_path").replace("/upload/",
     * "/upload/df2078d6c9eb46babb0df957127273ab/"); String file_thumbnail_path
     * = record.getStr("file_thumbnail_path").replace("/upload/",
     * "/upload/df2078d6c9eb46babb0df957127273ab/"); String file_original_path =
     * record.getStr("file_original_path").replace("/upload/",
     * "/upload/df2078d6c9eb46babb0df957127273ab/"); String file_image =
     * record.getStr("file_image"); Boolean file_is_external = false; String
     * system_create_user_id = record.getStr("system_create_user_id"); Date
     * system_create_time = record.getDate("system_create_time"); String
     * system_update_user_id = record.getStr("system_update_user_id"); Date
     * system_update_time = record.getDate("system_update_time"); Integer
     * system_version = 0; Boolean system_status =
     * record.getBoolean("system_status");
     * 
     * Kv sqlMap = Kv.create(); sqlMap.put(File.FILE_ID, file_id);
     * sqlMap.put(File.APP_ID, app_id); sqlMap.put(File.FILE_TYPE, file_type);
     * sqlMap.put(File.FILE_NAME, file_name); sqlMap.put(File.FILE_SUFFIX,
     * file_suffix); sqlMap.put(File.FILE_SIZE, file_size);
     ...
     * sqlMap.put(File.SYSTEM_STATUS, system_status); SqlPara sqlPara =
     * Db.getSqlPara("file.save", sqlMap); Db.update(sqlPara.getSql(),
     * sqlPara.getPara()); }
     * 
     * List<Record> brandRecordList =
     * Db.find("select * from JiYiGuan.table_brand"); for (Record record :
     * brandRecordList) { String product_brand_id = record.getStr("brand_id");
     * String app_id = "df2078d6c9eb46babb0df957127273ab"; String
     * product_brand_name = record.getStr("brand_name"); String
     * product_brand_image = ""; String product_brand_content =
     * record.getStr("brand_content"); String system_create_user_id =
     * record.getStr("system_create_user_id"); Date system_create_time =
     * record.getDate("system_create_time"); String system_update_user_id =
     * record.getStr("system_update_user_id"); Date system_update_time =
     * record.getDate("system_update_time"); Integer system_version = 0; Boolean
     * system_status = record.getBoolean("system_status");
     * 
     * Kv sqlMap = Kv.create(); sqlMap.put(ProductBrand.PRODUCT_BRAND_ID,
     * product_brand_id); sqlMap.put(ProductBrand.APP_ID, app_id);
     ...
     * sqlMap.put(ProductBrand.SYSTEM_STATUS, system_status); SqlPara sqlPara =
     * Db.getSqlPara("product_brand.save", sqlMap); Db.update(sqlPara.getSql(),
     * sqlPara.getPara()); }
     * 
     * List<Record> categoryRecordList = Db.
     * find("select * from JiYiGuan.table_category where parent_id = '3854e267ad7c4eb5a720d63d7615f6be'"
     * ); for (Record record : categoryRecordList) { String product_category_id
     * = record.getStr("category_id"); String app_id =
     * "df2078d6c9eb46babb0df957127273ab"; String product_category_parent_id =
     * record.getStr("parent_id"); String product_category_name =
     * record.getStr("category_name"); Integer product_category_sort =
     * record.getInt("category_sort"); String product_category_path =
     * record.getStr("category_path"); String system_create_user_id =
     * record.getStr("system_create_user_id"); Date system_create_time =
     * record.getDate("system_create_time"); String system_update_user_id =
     * record.getStr("system_update_user_id"); Date system_update_time =
     * record.getDate("system_update_time"); Integer system_version = 0; Boolean
     * system_status = record.getBoolean("system_status");
     * 
     * Kv sqlMap = Kv.create(); sqlMap.put(ProductCategory.PRODUCT_CATEGORY_ID,
     * product_category_id); sqlMap.put(ProductCategory.APP_ID, app_id);
     * sqlMap.put(ProductCategory.PRODUCT_CATEGORY_PARENT_ID,
     ...
     * sqlMap.put(ProductCategory.SYSTEM_STATUS, system_status); SqlPara sqlPara
     * = Db.getSqlPara("product_category.save", sqlMap);
     * Db.update(sqlPara.getSql(), sqlPara.getPara()); }
     * 
     * List<Record> productRecordList =
     * Db.find("select * from JiYiGuan.table_product"); for (Record record :
     * productRecordList) { String product_id = record.getStr("product_id");
     * String app_id = "df2078d6c9eb46babb0df957127273ab"; String
     * product_snap_id = ""; String product_category_id =
     * record.getStr("category_id"); String product_brand_id =
     * record.getStr("brand_id"); String product_name =
     * record.getStr("product_name"); String product_image =
     * record.getStr("product_image"); Boolean product_is_new =
     * record.getBoolean("product_is_new"); Boolean product_is_recommend =
     * record.getBoolean("product_is_recommend"); Boolean product_is_bargain =
     * record.getBoolean("product_is_bargain"); Boolean product_is_hot =
     * record.getBoolean("product_is_hot"); Boolean product_is_sold_out = false;
     * Boolean product_is_virtual = false; String product_content =
     * record.getStr("product_content"); Boolean product_status = true; String
     * system_create_user_id = record.getStr("system_create_user_id"); Date
     * system_create_time = record.getDate("system_create_time"); String
     * system_update_user_id = record.getStr("system_update_user_id"); Date
     * system_update_time = record.getDate("system_update_time"); Integer
     ...
     * JSONArray jsonArray = JSONArray.parseArray(product_image_list); for (int
     * i = 0; i < jsonArray.size(); i++) { String file_id =
     * jsonArray.getString(i);
     * 
     * ProductImage productImage = new ProductImage();
     * productImage.setFile_id(file_id); productImage.setProduct_id(product_id);
     * productImage.setProduct_file_sort(i); productImageList.add(productImage);
     ...
     * productImage.setSystem_status(system_status); } Kv map = Kv.create();
     * SqlPara sqlPara = Db.getSqlPara("product_image.save", map);
     * List<Object[]> parameterList = new ArrayList<Object[]>();
     * for(ProductImage productImage : productImageList) { List<Object>
     ...
     * objectList.add(system_update_time); objectList.add(system_version);
     * objectList.add(system_status); parameterList.add(objectList.toArray()); }
     * int[] result = Db.batch(sqlPara.getSql(),
     * Util.getObjectArray(parameterList), Constant.BATCH_SIZE);
     * 
     * Kv sqlMap = Kv.create(); sqlMap.put(Product.PRODUCT_ID, product_id);
     * sqlMap.put(Product.APP_ID, app_id); sqlMap.put(Product.PRODUCT_SNAP_ID,
     * product_snap_id); sqlMap.put(Product.PRODUCT_CATEGORY_ID,
     * product_category_id); sqlMap.put(Product.PRODUCT_BRAND_ID,
     * product_brand_id); sqlMap.put(Product.PRODUCT_NAME, product_name);
     ...
     * sqlMap.put(Product.PRODUCT_CONTENT,
     * product_content.replaceAll("jiyiguan", "chuangshi").replace("/upload/",
     * "/upload/df2078d6c9eb46babb0df957127273ab/"));
     ...
     * sqlMap.put(Product.SYSTEM_VERSION, 0); sqlMap.put(Product.SYSTEM_STATUS,
     * true); sqlPara = Db.getSqlPara("product.save", sqlMap);
     * Db.update(sqlPara.getSql(), sqlPara.getPara()); }
     * 
     * List<Record> skuRecordList =
     * Db.find("select * from JiYiGuan.table_sku where system_status = 1");
     * List<Object[]> productSkuParameterList = new ArrayList<Object[]>();
     * List<Object[]> productSkuPriceParameterList = new ArrayList<Object[]>();
     * for (Record record : skuRecordList) { String product_sku_id =
     * record.getStr("sku_id"); String product_id = record.getStr("product_id");
     * Boolean product_sku_is_default = true; String system_create_user_id =
     * record.getStr("system_create_user_id"); Date system_create_time =
     * record.getDate("system_create_time"); String system_update_user_id =
     * record.getStr("system_update_user_id"); Date system_update_time =
     * record.getDate("system_update_time"); Integer system_version = 0; Boolean
     ...
     * 
     * String product_price = record.getStr("product_price"); JSONArray
     * jsonArray = JSONArray.parseArray(product_price); String product_sku_price
     ...
     * 
     * product_sku_price = jsonObject.getString("product_price"); } List<Object>
     * productSkuPriceObjectList = new ArrayList<Object>();
     * productSkuPriceObjectList.add(product_sku_id);
     ...
     * productSkuPriceParameterList.add(productSkuPriceObjectList.toArray()); }
     * 
     * Kv map = Kv.create(); SqlPara sqlPara = Db.getSqlPara("product_sku.save",
     * map); Db.batch(sqlPara.getSql(),
     * Util.getObjectArray(productSkuParameterList), Constant.BATCH_SIZE);
     * 
     * map = Kv.create(); sqlPara = Db.getSqlPara("product_sku_price.save",
     * map); Db.batch(sqlPara.getSql(),
     * Util.getObjectArray(productSkuPriceParameterList), Constant.BATCH_SIZE);
     * 
     * 
     * map = Kv.create(); sqlPara = Db.getSqlPara("product_sku_commission.save",
     * map); List<Object[]> commissionParameterList = new ArrayList<Object[]>();
     * List<Record> commissionRecordList = Db.
     * find("select * from JiYiGuan.table_commission left join JiYiGuan.table_sku on JiYiGuan.table_sku.product_id = JiYiGuan.table_commission.product_id where JiYiGuan.table_commission.system_status = 1 and JiYiGuan.table_sku.system_status = 1"
     * ); for (Record record : commissionRecordList) { String sku_id =
     * record.getStr("sku_id"); String system_create_user_id =
     * record.getStr("system_create_user_id"); Date system_create_time =
     * record.getDate("system_create_time"); String system_update_user_id =
     * record.getStr("system_update_user_id"); Date system_update_time =
     * record.getDate("system_update_time"); Integer system_version = 0; Boolean
     ...
     * 
     * 
     * String product_price = record.getStr("product_commission"); JSONArray
     * jsonArray = JSONArray.parseArray(product_price); for (int i = 0; i <
     * jsonArray.size(); i++) { JSONObject jsonObject =
     * jsonArray.getJSONObject(i);
     * 
     * String member_level_id = jsonObject.getString("member_level_id");
     * 
     * if (!ValidateUtil.isNullOrEmpty(member_level_id)) { List<Object>
     * objectList = new ArrayList<Object>(); objectList.add(sku_id);
     ...
     * commissionParameterList.add(objectList.toArray()); } } List<Object>
     * objectList = new ArrayList<Object>(); objectList.add(sku_id);
     * objectList.add("81f04950c487433bb571e51c8fcd5fde");
     * objectList.add("二级客户"); objectList.add("0");
     * objectList.add(system_create_user_id);
     * objectList.add(system_create_time);
     * objectList.add(system_update_user_id);
     * objectList.add(system_update_time); objectList.add(system_version);
     ...
     * 
     * int[] result = Db.batch(sqlPara.getSql(),
     * Util.getObjectArray(commissionParameterList), Constant.BATCH_SIZE); }
     * 
     * private void initXingXiaoDadabase() { List<Record> userRecordList =
     * Db.find("select * from XingXiao.table_user"); for (Record record :
     * userRecordList) { String user_id = record.getStr("user_id"); String
     * app_id = "c1af3f1ae00e4e0da9b20f5bd41b4279"; String object_id =
     * record.getStr("object_id"); String user_type =
     * record.getStr("user_type"); String user_account =
     * record.getStr("user_account"); String user_mobile =
     * record.getStr("user_phone"); String user_email =
     * record.getStr("user_email"); String user_password =
     * record.getStr("user_password"); String user_name =
     * record.getStr("user_name"); String user_avatar = Util.getRandomUUID();
     * String wechat_open_id = record.getStr("wechat_open_id"); String
     * wechat_union_id = record.getStr("wechat_union_id"); String
     * system_create_user_id = record.getStr("system_create_user_id"); Date
     * system_create_time = record.getDate("system_create_time"); String
     * system_update_user_id = record.getStr("system_update_user_id"); Date
     * system_update_time = record.getDate("system_update_time"); Integer
     ...
     * record.getBoolean("system_status");
     * 
     * String file_id = user_avatar; String file_type = FileType.IMAGE.getKey();
     * String file_name = ""; String file_suffix = "jpeg"; Integer file_size =
     * 0; String file_path = record.getStr("user_avatar"); String
     * file_thumbnail_path = record.getStr("user_avatar"); String
     * file_original_path = record.getStr("user_avatar"); String file_image =
     ...
     * sqlMap.put(File.SYSTEM_UPDATE_TIME, system_update_time);
     * sqlMap.put(File.SYSTEM_VERSION, 0); sqlMap.put(File.SYSTEM_STATUS, true);
     * SqlPara sqlPara = Db.getSqlPara("file.save", sqlMap);
     * Db.update(sqlPara.getSql(), sqlPara.getPara());
     * 
     * sqlMap = Kv.create(); sqlMap.put(User.USER_ID, user_id);
     * sqlMap.put(User.APP_ID, app_id); sqlMap.put(User.OBJECT_ID, object_id);
     * sqlMap.put(User.USER_TYPE, user_type); sqlMap.put(User.USER_NAME,
     * user_name); sqlMap.put(User.USER_AVATAR, user_avatar);
     * sqlMap.put(User.USER_ACCOUNT, user_account); sqlMap.put(User.USER_MOBILE,
     * user_mobile); sqlMap.put(User.USER_EMAIL, user_email);
     ...
     * sqlMap.put(User.SYSTEM_UPDATE_TIME, system_update_time);
     * sqlMap.put(User.SYSTEM_VERSION, system_version);
     * sqlMap.put(User.SYSTEM_STATUS, system_status); sqlPara =
     * Db.getSqlPara("user.save", sqlMap); Db.update(sqlPara.getSql(),
     * sqlPara.getPara()); }
     * 
     * List<Record> memberRecordList =
     * Db.find("select * from XingXiao.table_member"); for (Record record :
     * memberRecordList) { String member_id = record.getStr("member_id"); String
     * app_id = "c1af3f1ae00e4e0da9b20f5bd41b4279"; String user_id =
     * record.getStr("user_id"); String member_parent_id =
     * record.getStr("parent_id"); String from_qrcode_id =
     * record.getStr("from_scene_id"); String qrcode_id =
     * record.getStr("scene_id"); String member_level_id =
     * record.getStr("member_level_id"); String member_parent_path =
     * record.getStr("parent_path"); Boolean member_status =
     * record.getBoolean("member_status"); String system_create_user_id =
     * record.getStr("system_create_user_id"); Date system_create_time =
     * record.getDate("system_create_time"); String system_update_user_id =
     * record.getStr("system_update_user_id"); Date system_update_time =
     * record.getDate("system_update_time"); Integer system_version = 0; Boolean
     * system_status = record.getBoolean("system_status");
     * 
     * Kv sqlMap = Kv.create(); sqlMap.put(Member.MEMBER_ID, member_id);
     * sqlMap.put(Member.APP_ID, app_id); sqlMap.put(Member.USER_ID, user_id);
     ...
     * sqlMap.put(User.SYSTEM_VERSION, system_version);
     * sqlMap.put(User.SYSTEM_STATUS, system_status); SqlPara sqlPara =
     * Db.getSqlPara("member.save", sqlMap); Db.update(sqlPara.getSql(),
     * sqlPara.getPara()); }
     * 
     * List<Record> memberLevelRecordList =
     * Db.find("select * from XingXiao.table_member_level"); for (Record record
     * : memberLevelRecordList) { String member_level_id =
     * record.getStr("member_level_id"); String app_id =
     * "c1af3f1ae00e4e0da9b20f5bd41b4279"; String member_level_name =
     * record.getStr("member_level_name"); Integer member_level_value =
     * record.getInt("member_level_value"); Integer member_level_sort =
     * record.getInt("member_level_sort"); String system_create_user_id =
     * record.getStr("system_create_user_id"); Date system_create_time =
     ...
     * sqlPara.getPara()); }
     * 
     * List<Record> sceneRecordList =
     * Db.find("select * from XingXiao.table_scene"); for (Record record :
     * sceneRecordList) { String qrcode_id = record.getStr("scene_id"); String
     * app_id = "c1af3f1ae00e4e0da9b20f5bd41b4279"; String object_id =
     * record.getStr("object_id"); String qrcode_type =
     * record.getStr("scene_type"); String qrcode_url =
     * record.getStr("scene_qrcode"); Integer qrcode_add =
     * record.getInt("scene_add"); Integer qrcode_cancel =
     * record.getInt("scene_add"); Boolean qrcode_status =
     * !record.getBoolean("scene_is_expire"); String system_create_user_id =
     * record.getStr("system_create_user_id"); Date system_create_time =
     * record.getDate("system_create_time"); String system_update_user_id =
     * record.getStr("system_update_user_id"); Date system_update_time =
     * record.getDate("system_update_time"); Integer system_version = 0; Boolean
     * system_status = record.getBoolean("system_status");
     * 
     * Kv sqlMap = Kv.create(); sqlMap.put(Qrcode.QRCODE_ID, qrcode_id);
     * sqlMap.put(Qrcode.APP_ID, app_id); sqlMap.put(Qrcode.OBJECT_ID,
     * object_id); sqlMap.put(Qrcode.QRCODE_TYPE, qrcode_type);
     * sqlMap.put(Qrcode.QRCODE_URL, qrcode_url); sqlMap.put(Qrcode.QRCODE_ADD,
     * qrcode_add); sqlMap.put(Qrcode.QRCODE_CANCEL, qrcode_cancel);
     ...
     * sqlMap.put(User.SYSTEM_VERSION, system_version);
     * sqlMap.put(User.SYSTEM_STATUS, system_status); SqlPara sqlPara =
     * Db.getSqlPara("qrcode.save", sqlMap); Db.update(sqlPara.getSql(),
     * sqlPara.getPara()); } }
     */
