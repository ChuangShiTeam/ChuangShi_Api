...
public class StockReplenishService extends Service {
    ...
    public Integer countByApp_idAndStock_replenish_typeOrLikeUser_name(String app_id, String stock_replenish_name, String user_name) {
        return stockReplenishCache.countByApp_idAndStock_replenish_typeOrLikeUser_name(app_id, stock_replenish_name, user_name);
    }

    public Integer countByOrApp_idAndStock_replenish_typeOrLikeUser_name(String app_id, String stock_replenish_name, String user_name) {
        return stockReplenishCache.countByOrApp_idAndStock_replenish_typeOrLikeUser_name(app_id, stock_replenish_name, user_name);
    }
    ...
    public List<StockReplenish> listByApp_idAndStock_replenish_typeOrLikeUser_nameAndLimit(String app_id, String stock_replenish_name, String user_name, int m, int n) {
        return stockReplenishCache.listByApp_idAndStock_replenish_typeOrLikeUser_nameAndLimit(app_id, stock_replenish_name, user_name, m, n);
    }

    public List<StockReplenish> listByOrApp_idAndStock_replenish_typeOrLikeUser_nameAndLimit(String app_id, String stock_replenish_name, String user_name, int m, int n) {
        return stockReplenishCache.listByOrApp_idAndStock_replenish_typeOrLikeUser_nameAndLimit(app_id, stock_replenish_name, user_name, m, n);
    }
