...
public class CertificateService extends Service {
    ...
    public Boolean save(String certificate_id, String app_id, String user_id, String certificate_number, Date certificate_start_date, Date certificate_end_date, String certificate_content, String certificate_file, String system_create_user_id) {
        return certificateCache.save(certificate_id, app_id, user_id, certificate_number, certificate_start_date, certificate_end_date, certificate_content, certificate_file, system_create_user_id);
    }
    ...
    public Boolean updateValidateSystem_version(String certificate_id, String user_id, String certificate_number, Date certificate_start_date, Date certificate_end_date, String certificate_content, String certificate_file, String system_update_user_id, Integer system_version) {
        return certificateCache.updateValidateSystem_version(certificate_id, user_id, certificate_number, certificate_start_date, certificate_end_date, certificate_content, certificate_file, system_update_user_id, system_version);
    }
    ...
    public Boolean deleteByCertificate_idAndSystem_update_user_idValidateSystem_version(String certificate_id, String system_update_user_id, Integer system_version) {
        return certificateCache.deleteByCertificate_idAndSystem_update_user_idValidateSystem_version(certificate_id, system_update_user_id, system_version);
    }
