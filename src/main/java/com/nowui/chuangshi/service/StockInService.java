...
public class StockInService extends Service {
    ...
    public Integer countByApp_idOrWarehouse_idAndStock_in_typeOrLikeStock_in_batchOrLikeUser_name(String app_id, String warehouse_id, String stock_in_type, String stock_in_batch, String user_name) {
        return stockInCache.countByApp_idOrWarehouse_idAndStock_in_typeOrLikeStock_in_batchOrLikeUser_name(app_id, warehouse_id, stock_in_type, stock_in_batch, user_name);
    }
    ...
    public Integer countByOrApp_idOrWarehouse_idAndStock_in_typeOrLikeStock_in_batchOrLikeUser_name(String app_id, String warehouse_id, String stock_in_type, String stock_in_batch, String user_name) {
        return stockInCache.countByOrApp_idOrWarehouse_idAndStock_in_typeOrLikeStock_in_batchOrLikeUser_name(app_id, warehouse_id, stock_in_type, stock_in_batch, user_name);
    }
    ...
    public List<StockIn> listByApp_idOrWarehouse_idAndStock_in_typeOrLikeStock_in_batchOrLikeUser_nameAndLimit(String app_id, String warehouse_id, String stock_in_type, String stock_in_batch, String user_name, int m, int n) {
       return stockInCache.listByApp_idOrWarehouse_idAndStock_in_typeOrLikeStock_in_batchOrLikeUser_nameAndLimit(app_id, warehouse_id, stock_in_type, stock_in_batch, user_name, m, n);
    }
    ...
    public List<StockIn> listByOrApp_idOrWarehouse_idAndStock_in_typeOrLikeStock_in_batchOrLikeUser_nameAndLimit(String app_id, String warehouse_id, String stock_in_type, String stock_in_batch, String user_name, int m, int n) {
        return stockInCache.listByOrApp_idOrWarehouse_idAndStock_in_typeOrLikeStock_in_batchOrLikeUser_nameAndLimit(app_id, warehouse_id, stock_in_type, stock_in_batch, user_name, m, n);
    }
    ...
    public Boolean updateValidateSystem_version(String stock_in_id, String warehouse_id, String purchase_order_id, String object_id, String stock_in_batch, String stock_in_type, Integer stock_in_quantity, String stock_in_status, String system_update_user_id, Integer system_version) {
        return stockInCache.updateValidateSystem_version(stock_in_id, warehouse_id, purchase_order_id, object_id, stock_in_batch, stock_in_type, stock_in_quantity, stock_in_status, system_update_user_id, system_version);
    }
    ...
    public Boolean save(String app_id, String warehouse_id, String purchase_order_id, String object_id, String stock_in_batch, String stock_in_type, List<StockInProductSku> stockInProductSkuList, String system_create_user_id) {
    	...
    	Boolean result = stockInCache.save(stock_in_id, app_id, warehouse_id, purchase_order_id, object_id, stock_in_batch, stock_in_type, stock_in_quantity, "", system_create_user_id);
		if (result) {
