...
public class FileService extends Service {
    ...
    public Integer countByApp_idAndFile_typeAndSystem_create_user_id(String app_id, String file_type, String system_create_user_id, String request_app_id, String request_http_id, String request_user_id) {
        return fileCache.countByApp_idAndFile_typeAndSystem_create_user_id(app_id, file_type, system_create_user_id, request_app_id, request_http_id, request_user_id);
    }
    ...
    public Integer countByOrApp_idAndFile_type(String app_id, String file_type, String request_app_id, String request_http_id, String request_user_id) {
        return fileCache.countByOrApp_idAndFile_type(app_id, file_type, request_app_id, request_http_id, request_user_id);
    }
    ...
    public List<File> listByApp_idAndFile_typeAndSystem_create_user_idAndLimit(String app_id, String file_type, String system_create_user_id, int m, int n, String request_app_id, String request_http_id, String request_user_id) {
        return fileCache.listByApp_idAndFile_typeAndSystem_create_user_idAndLimit(app_id, file_type, system_create_user_id, m, n, request_app_id, request_http_id, request_user_id);
    }
    ...
    public List<File> listByOrApp_idAndFile_typeAndLimit(String app_id, String file_type, int m, int n, String request_app_id, String request_http_id, String request_user_id) {
        return fileCache.listByOrApp_idAndFile_typeAndLimit(app_id, file_type, m, n, request_app_id, request_http_id, request_user_id);
    }
    ...
    public List<Map<String, Object>> upload(List<UploadFile> uploadFileList, String request_app_id, String request_http_id, String request_user_id) {
        ...
        for (UploadFile uploadFile : uploadFileList) {
            ...
            Boolean result = save(file_id, request_app_id, file_type, file_name, file_suffix, file_size, file_path, file_thumbnail_path, file_original_path, file_image, request_user_id, request_app_id, request_http_id, request_user_id);
