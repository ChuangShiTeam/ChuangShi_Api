...
public class GuangqiCustomerDao extends Dao {
    ...
    public Integer countByApp_id(String app_id) {
        ...
        logSql("guangqi_customer", "countByApp_id", sqlPara);
    ...
    public Integer countByOrApp_id(String app_id) {
        ...
        logSql("guangqi_customer", "countByOrApp_id", sqlPara);
    ...
    public Integer countByCustomer_phone(String customer_phone) {
        ...
        logSql("guangqi_customer", "countByCustomer_phone", sqlPara);
    ...
    public List<GuangqiCustomer> listByApp_idAndSystem_create_timeAndLimit(String app_id, Date system_create_time, int m, int n) {
        ...
        logSql("guangqi_customer", "listByApp_idAndSystem_create_timeAndLimit", sqlPara);
    ...
    public List<GuangqiCustomer> listByApp_idAndCustomer_nameAndLimit(String app_id, String customer_name, int m, int n) {
        ...
        logSql("guangqi_customer", "listByApp_idAndCustomer_nameAndLimit", sqlPara);
    ...
    public List<GuangqiCustomer> listByOrApp_idAndLimit(String app_id, int m, int n) {
        ...
        logSql("guangqi_customer", "listByOrApp_idAndLimit", sqlPara);
    ...
    public GuangqiCustomer findByCustomer_id(String customer_id) {
        ...
        logSql("guangqi_customer", "findByCustomer_id", sqlPara);
    ...
    public Boolean save(String customer_id, String app_id, String customer_name, String customer_phone, String customer_province, String customer_city, String costomer_dealer, String system_create_user_id) {
        ...
        logSql("guangqi_customer", "save", sqlPara);

        return Db.update(sqlPara.getSql(), sqlPara.getPara()) != 0;
    }

    public Boolean update(String customer_id, String customer_name, String customer_phone, String customer_province, String customer_city, String costomer_dealer, String system_update_user_id, Integer system_version) {
        Kv sqlMap = Kv.create();
        sqlMap.put(GuangqiCustomer.CUSTOMER_ID, customer_id);
        sqlMap.put(GuangqiCustomer.CUSTOMER_NAME, customer_name);
        sqlMap.put(GuangqiCustomer.CUSTOMER_PHONE, customer_phone);
        ...
        logSql("guangqi_customer", "update", sqlPara);
    ...
    public Boolean deleteByCustomer_idAndSystem_version(String customer_id, String system_update_user_id, Integer system_version) {
        ...
        logSql("guangqi_customer", "deleteByCustomer_idAndSystem_version", sqlPara);
