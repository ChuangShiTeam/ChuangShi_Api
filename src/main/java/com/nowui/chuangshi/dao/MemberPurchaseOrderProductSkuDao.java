...
public class MemberPurchaseOrderProductSkuDao extends Dao {
    ...
    public List<MemberPurchaseOrderProductSku> listByMember_purchase_order_id(String member_purchase_order_id) {
        ...
        return new MemberPurchaseOrderProductSku().find(sqlPara.getSql(), sqlPara.getPara());
    }
    ...
    public Boolean save(String member_purchase_order_id, String product_sku_id, String product_snap_id, Integer product_sku_quantity, BigDecimal product_sku_amount, String system_create_user_id) {
        ...
        sqlMap.put(MemberPurchaseOrderProductSku.PRODUCT_SNAP_ID, product_snap_id);
        sqlMap.put(MemberPurchaseOrderProductSku.PRODUCT_SKU_QUANTITY, product_sku_quantity);
        sqlMap.put(MemberPurchaseOrderProductSku.PRODUCT_SKU_AMOUNT, product_sku_amount);
