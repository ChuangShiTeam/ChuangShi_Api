...
public class GuangqiCustomerPrizeDao extends Dao {
    ...
    public Integer countByApp_id(String app_id) {
        ...
        logSql("guangqi_customer_prize", "countByApp_id", sqlPara);
    ...
    public Integer countByOrApp_id(String app_id) {
        ...
        logSql("guangqi_customer_prize", "countByOrApp_id", sqlPara);
    ...
    public Integer countByApp_idAndCustomer_id(String app_id, String customer_id) {
        ...
        logSql("guangqi_customer_prize", "countByApp_idAndCustomer_id", sqlPara);
    ...
    public Integer countByApp_idAndPrize_id(String app_id, String prize_id) {
        ...
        logSql("guangqi_customer_prize", "countByApp_idAndPrize_id", sqlPara);
    ...
    public Integer countByApp_idAndPrize_idAndCustomer_prize_date(String app_id, String prize_id, String customer_prize_date) {
        ...
        logSql("guangqi_customer_prize", "countByApp_idAndPrize_idAndCustomer_prize_date", sqlPara);
    ...
    public List<GuangqiCustomerPrize> listByApp_idAndSystem_create_timeAndLimit(String app_id, Date system_create_time, int m, int n) {
        ...
        logSql("guangqi_customer_prize", "listByApp_idAndSystem_create_timeAndLimit", sqlPara);
    ...
    public List<GuangqiCustomerPrize> listByApp_id(String app_id) {
        ...
        logSql("guangqi_customer_prize", "listByApp_id", sqlPara);
    ...
    public List<GuangqiCustomerPrize> listByApp_idAndLimit(String app_id, int m, int n) {
        ...
        logSql("guangqi_customer_prize", "listByApp_idAndLimit", sqlPara);
    ...
    public List<GuangqiCustomerPrize> listByOrApp_idAndLimit(String app_id, int m, int n) {
        ...
        logSql("guangqi_customer_prize", "listByOrApp_idAndLimit", sqlPara);
    ...
    public GuangqiCustomerPrize findByCustomer_prize_id(String customer_prize_id) {
        ...
        logSql("guangqi_customer_prize", "findByCustomer_prize_id", sqlPara);
    ...
    public Boolean save(String customer_prize_id, String app_id, String customer_id, String prize_id, String customer_prize_date, String system_create_user_id, Integer prize_quantity, Integer prize_limit) {
        ...
        logSql("guangqi_customer_prize", "save", sqlPara);

        return Db.update(sqlPara.getSql(), sqlPara.getPara()) != 0;
    }

    public Boolean update(String customer_prize_id, String customer_id, String prize_id, String customer_prize_date, String system_update_user_id, Integer system_version) {
        Kv sqlMap = Kv.create();
        sqlMap.put(GuangqiCustomerPrize.CUSTOMER_PRIZE_ID, customer_prize_id);
        sqlMap.put(GuangqiCustomerPrize.CUSTOMER_ID, customer_id);
        sqlMap.put(GuangqiCustomerPrize.PRIZE_ID, prize_id);
        ...
        logSql("guangqi_customer_prize", "update", sqlPara);

        return Db.update(sqlPara.getSql(), sqlPara.getPara()) != 0;
    }

    public Boolean deleteByCustomer_prize_idAndSystem_version(String customer_prize_id, String system_update_user_id, Integer system_version) {
        Kv sqlMap = Kv.create();
        sqlMap.put(GuangqiCustomerPrize.CUSTOMER_PRIZE_ID, customer_prize_id);
        sqlMap.put(GuangqiCustomerPrize.SYSTEM_UPDATE_USER_ID, system_update_user_id);
        sqlMap.put(GuangqiCustomerPrize.SYSTEM_UPDATE_TIME, new Date());
        ...
        logSql("guangqi_customer_prize", "deleteByCustomer_prize_idAndSystem_version", sqlPara);
