...
public class AppController extends Controller {
    ...
    public void save() {
    	validateRequest_app_id();
        validate(App.APP_NAME, App.APP_SECRET, App.WECHAT_APP_ID, App.WECHAT_APP_SECRET, App.WECHAT_MCH_ID, App.WECHAT_MCH_KEY, App.APP_IS_STOCK, App.APP_IS_COMMISSION, App.APP_COMMISSION_LEVEL);
        ...
        Boolean result = appService.save(app_id, model.getApp_name(), model.getApp_secret(), model.getWechat_app_id(), model.getWechat_app_secret(), model.getWechat_mch_id(), model.getWechat_mch_key(), model.getApp_is_stock(), model.getApp_is_commission(), model.getApp_commission_level(), request_user_id);
