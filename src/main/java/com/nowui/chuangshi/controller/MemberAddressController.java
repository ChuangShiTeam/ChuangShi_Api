...
public class MemberAddressController extends Controller {
    ...
    public void save() {
        validateRequest_app_id();
        validate(MemberAddress.MEMBER_ID, MemberAddress.USER_ID, MemberAddress.MEMBER_ADDRESS_NAME, MemberAddress.MEMBER_ADDRESS_PHONE, MemberAddress.MEMBER_ADDRESS_PROVINCE, MemberAddress.MEMBER_ADDRESS_CITY, MemberAddress.MEMBER_ADDRESS_AREA, MemberAddress.MEMBER_ADDRESS_STREET, MemberAddress.MEMBER_DELIVERY_IS_DEFAULT);
...
//        }
    ...
    public void systemSave() {
        validateRequest_app_id();
        validate(MemberAddress.APP_ID, MemberAddress.MEMBER_ID, MemberAddress.USER_ID, MemberAddress.MEMBER_ADDRESS_NAME, MemberAddress.MEMBER_ADDRESS_PHONE, MemberAddress.MEMBER_ADDRESS_PROVINCE, MemberAddress.MEMBER_ADDRESS_CITY, MemberAddress.MEMBER_ADDRESS_AREA, MemberAddress.MEMBER_ADDRESS_STREET, MemberAddress.MEMBER_DELIVERY_IS_DEFAULT);
