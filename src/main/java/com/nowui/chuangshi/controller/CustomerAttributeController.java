...
public class CustomerAttributeController extends Controller {
    ...
    public void list() {
        ...
        List<CustomerAttribute> resultList = customerAttributeService.listByApp_idAndSystem_create_timeAndLimit(request_app_id, jsonObject.getDate(Constant.LAST_CREATE_TIME), 0, getN());
    ...
    public void find() {
        ...
        CustomerAttribute customer_attribute = customerAttributeService.findByCustomer_attribute_id(model.getCustomer_attribute_id());
    ...
    public void adminList() {
        ...
        Integer total = customerAttributeService.countByApp_idOrLikeCustomer_attribute_name(request_app_id, model.getCustomer_attribute_name());
    ...
    public void systemList() {
        ...
        Integer total = customerAttributeService.countByOrApp_idOrLikeCustomer_attribute_name(model.getApp_id(), model.getCustomer_attribute_name());
        List<CustomerAttribute> resultList = customerAttributeService.listByOrApp_idOrLikeCustomer_attribute_nameAndLimit(model.getApp_id(), model.getCustomer_attribute_name(), getM(), getN());
