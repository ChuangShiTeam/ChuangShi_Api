...
public class FeijiuRecommendCustomerController extends Controller {
    ...
    public void systemList() {
        ...
        Integer total = feijiuRecommendCustomerService.countByOrApp_id(model.getApp_id(), request_app_id, request_http_id, request_user_id);
        List<FeijiuRecommendCustomer> resultList = feijiuRecommendCustomerService.listByOrApp_idAndLimit(model.getApp_id(), getM(), getN(), request_app_id, request_http_id, request_user_id);
    ...
    public void systemSave() {
        ...
        Boolean result = feijiuRecommendCustomerService.save(customer_id, model.getApp_id(), model.getCustomer_name(), model.getCustomer_phone(), model.getCustomer_city(), request_user_id, request_app_id, request_http_id, request_user_id);
