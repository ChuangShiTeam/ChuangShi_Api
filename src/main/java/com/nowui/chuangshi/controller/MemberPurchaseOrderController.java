...
public class MemberPurchaseOrderController extends Controller {
    ...
    public void list() {
        ...
        for (MemberPurchaseOrder result : resultList) {
            ...
            // 根据进货单获取商品列表
            List<MemberPurchaseOrderProductSku> memberPurchaseOrderProductSkuList = memberPurchaseOrderProductSkuService.listByMember_purchase_order_id(result.getMember_purchase_order_id());
            for (MemberPurchaseOrderProductSku memberPurchaseOrderProductSku : memberPurchaseOrderProductSkuList) {
                ProductSku productSku = productSkuService.findByProduct_sku_id(memberPurchaseOrderProductSku.getProduct_sku_id());
                Product product = productService.findByProduct_id(productSku.getProduct_id());
                memberPurchaseOrderProductSku.put(Product.PRODUCT_NAME, product.getProduct_name());  //商品名称
                memberPurchaseOrderProductSku.put(Product.PRODUCT_IMAGE, fileService.getFile_path(product.getProduct_image()));
                memberPurchaseOrderProductSku.keep(MemberPurchaseOrderProductSku.PRODUCT_SKU_ID, MemberPurchaseOrderProductSku.PRODUCT_SKU_AMOUNT,
            ...
            result.keep(MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_ID, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_FLOW, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_TOTAL_QUANTITY,
                    MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_PRODUCT_AMOUNT, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_AMOUNT, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_PRODUCT_SKU_LIST);
        }
    ...
    public void find() throws Exception {
        ...
        // 根据进货单获取商品列表
        List<MemberPurchaseOrderProductSku> memberPurchaseOrderProductSkuList = memberPurchaseOrderProductSkuService.listByMember_purchase_order_id(member_purchase_order.getMember_purchase_order_id());
        for (MemberPurchaseOrderProductSku memberPurchaseOrderProductSku : memberPurchaseOrderProductSkuList) {
            ProductSku productSku = productSkuService.findByProduct_sku_id(memberPurchaseOrderProductSku.getProduct_sku_id());
            Product product = productService.findByProduct_id(productSku.getProduct_id());
        ...
        member_purchase_order.put(MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_PRODUCT_SKU_LIST, memberPurchaseOrderProductSkuList);
        ...
        if (member_purchase_order.getMember_purchase_order_flow().equals(MemberPurchaseOrderFlow.WAIT_RECEIVE.getKey())
                || member_purchase_order.getMember_purchase_order_flow().equals(MemberPurchaseOrderFlow.COMPLETE.getKey())) {
            expressList = memberPurchaseOrderExpressService.listByMember_purchase_order_id(member_purchase_order.getMember_purchase_order_id());
        ...
        member_purchase_order.keep(MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_ID, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_PRODUCT_AMOUNT, 
                MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_EXPRESS_AMOUNT, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_DISCOUNT_AMOUNT,
                MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_AMOUNT, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_TOTAL_QUANTITY,
                MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_RECEIVER_NAME, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_RECEIVER_MOBILE,
                MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_RECEIVER_PROVINCE, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_RECEIVER_CITY,
                MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_RECEIVER_AREA, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_RECEIVER_ADDRESS,
                MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_FLOW, MemberPurchaseOrder.SYSTEM_CREATE_TIME,
                MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_PRODUCT_SKU_LIST, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_EXPRESS_LIST,
    ...
    public void save() {
        ...
        validate(MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_IS_WAREHOUSE_RECEIVE, 
                ...
                Product.PRODUCT_SKU_LIST, "open_id");
        JSONObject jsonObject = getParameterJSONObject();
        Boolean member_purchase_order_is_warehouse_receive = jsonObject.getBoolean(MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_IS_WAREHOUSE_RECEIVE);
        //非仓库待收，需填写收货人信息
        ...
        for (int i = 0; i < jsonArray.size(); i++) {
            ...
            memberPurchaseOrderProductSkuService.save(member_purchase_order_id, memberPurchaseOrderProductSku.getProduct_sku_id(), "",
    ...
    public void pay() {
        ...
        Map<String, String> result = memberPurchaseOrderService.pay(model.getMember_purchase_order_id(), open_id, pay_type, request_user_id);
    ...
    public void confirm() {
        ...
        MemberPurchaseOrder memberPurchaseOrder = memberPurchaseOrderService.findByMember_purchase_order_id(model.getMember_purchase_order_id());
        ...
        memberPurchaseOrder.keep(MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_IS_PAY, MemberPurchaseOrder.MEMBER_PURCHASE_ORDER_AMOUNT);
